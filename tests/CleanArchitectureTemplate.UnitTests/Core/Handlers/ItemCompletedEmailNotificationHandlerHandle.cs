...
using CleanArchitectureTemplate.Core.ProjectAggregate.Events;
using CleanArchitectureTemplate.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace CleanArchitectureTemplate.UnitTests.Core.Handlers;
